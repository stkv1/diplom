...
*Реализовано с помощью модуля yandex_compute_snapshot_schedule. Периодичность бэкапа уазана ежедневной. Число хранимых снимков ограничено 7, таким образом время жизни одного снимка - одна неделя*
